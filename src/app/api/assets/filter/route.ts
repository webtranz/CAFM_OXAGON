...
const columnFilterFields: Record<string, string[]> = {
  ...
  combinedLocationCode: ["combinedLocationCode", "locationCode", "room"],
  fullLocationPath: ["fullLocationPath", "locationDesc"],
  ...
  if (locationQuery) {
    andFilters.push({
      OR: [
        ...
        { combinedLocationCode: { contains: locationQuery, mode: "insensitive" } },
        { fullLocationPath: { contains: locationQuery, mode: "insensitive" } },
